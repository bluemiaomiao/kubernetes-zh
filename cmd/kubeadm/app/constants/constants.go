...
const (
	...
	// CACertAndKeyBaseName 定义证书颁发机构的基本名称
	...
	// ServiceAccountKeyBaseName 定义服务协议密钥库名称
	ServiceAccountKeyBaseName = "sa"
	// ServiceAccountPublicKeyName 定义服务协议公钥基础名称
	ServiceAccountPublicKeyName = "sa.pub"
	// ServiceAccountPrivateKeyName 定义服务协议私钥基础名称
	...
	// KubeletKubeConfigFileName 定义kubeconfig的文件名，控制平面kubelet将使用该文件名与API服务器进行对话
	KubeletKubeConfigFileName = "kubelet.conf"
	// ControllerManagerKubeConfigFileName 定义控制器管理器的kubeconfig文件的文件名
	ControllerManagerKubeConfigFileName = "controller-manager.conf"
	// SchedulerKubeConfigFileName 定义调度程序的kubeconfig文件的文件名
